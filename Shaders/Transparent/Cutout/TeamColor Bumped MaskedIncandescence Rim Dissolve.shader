...
Shader "Alloy/Transparent/Cutout/TeamColor Bumped MaskedIncandescence Rim Dissolve" {
Properties {
	// Dissolve Parameters
...
CGPROGRAM
    ...
    #pragma target 3.0
    #pragma surface AlloySurf AlloyBrdf vertex:AlloyVert finalcolor:AlloyFinalColor alphatest:_Cutoff addshadow fullforwardshadows noambient
