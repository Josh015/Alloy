...
Shader "Alloy/FX/Transparent/Cutout/Dissolve Bumped MaskedIncandescence Rim" {
Properties {
	// Dissolve Parameters
...
CGPROGRAM
    ...
    #pragma target 3.0
    #pragma surface AlloySurf AlloyBrdf vertex:AlloyVert finalcolor:AlloyFinalColor addshadow fullforwardshadows noambient novertexlights
